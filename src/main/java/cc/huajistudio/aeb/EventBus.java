...
import cc.huajistudio.aeb.generator.AsmInvokerGenerator;
import cc.huajistudio.aeb.generator.InvokerGenerator;
import cc.huajistudio.aeb.generator.ReflectionInvokerGenerator;
import cc.huajistudio.aeb.quickstart.AnnotatedSubscriberFinder;
import cc.huajistudio.aeb.strategy.EnumHierarchyStrategy;
import cc.huajistudio.aeb.strategy.ISubscriberStrategy;
import cc.huajistudio.aeb.auxiliary.IDeadEventHandler;
import cc.huajistudio.aeb.auxiliary.ISubscriberExceptionHandler;
import cc.huajistudio.aeb.quickstart.EventSubscriber;
import cc.huajistudio.aeb.quickstart.LoggingSubscriberExceptionHandler;
import cc.huajistudio.aeb.quickstart.DiscardDeadEventHandler;
import cc.huajistudio.aeb.strategy.EnumInvokerGenerator;
import cc.huajistudio.aeb.util.EventBusBuilder;
 ...
 * 
 * <h2>How to create</h2>
 * <p>You can just create the event bus by its constructor, or build it by {@link EventBusBuilder}.<br/>
 ...
 * {@link AnnotatedSubscriberFinder} as a <b>default</b> subscriber strategy.
 * It will find the methods which have a special annotation. If you want to use it, put a 
 * {@link EventSubscriber} annotation in your subscriber method.
